...
import conunterImg from "../assets/images/counter-timer-img.png";
            ...
            <Col lg="6" md="6">
              <div className="hero__content">
                ...
                <p>
                  ...
                  Provident beatae cum doloremque mollitia modi culpa
                  consequuntur facilis nam assumenda nostrum.
                </p>
                <motion.button
                  whileTap={{ scale: 1.2 }}
                  className="buy__btn mx-2"
                >
          ...
          <Row>
            <Col lg="6" md="12" className="count__down-col">
              <div className="clock__top-content">
                ...
                <h3 className="text-white  fs-6 mb3">Qulity Armchair</h3>
              </div>
              <Clock />
      ...
      <section className="new__arrivals">
        <Container>
          <Row>
            ...
            <ProductList data={wirelesProducts} />
          </Row>
        </Container>
      </section>
